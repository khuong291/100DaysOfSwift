...
class MenuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func updateArrayMenuOptions(){
        arrayMenuOptions.append(["title":"Ếch Kì Diệu", "icon":"echkidieu"])
        arrayMenuOptions.append(["title":"Khủng Long Lửa", "icon":"khunglonglua"])
        arrayMenuOptions.append(["title":"Rùa Kini", "icon":"ruakini"])
