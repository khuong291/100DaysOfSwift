...
//
//  Created by Khuong Pham on 6/13/16.
...
class ViewController: UIViewController {
    ...
    @IBAction func handlePan(recognizer: UIPanGestureRecognizer) {
        ...
        let touchPosition : CGPoint = recognizer.locationInView(self.view)
        let viewPosition = growView.center

        let xDist : CGFloat = (touchPosition.x - viewPosition.x)
        let yDist : CGFloat = (touchPosition.y - viewPosition.y)
